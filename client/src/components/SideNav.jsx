...
const SideNav = () => {
  return (
    <aside className="flex relative left-0  flex-col w-64 h-full px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
      <div className="flex justify-center">
        <Link to="/">
          <img className="w-auto h-16 text-center" src={logo} alt="Logo here" />
        </Link>
      </div>
 ...
 */}
          ...
          >
            ...
            <span className="mx-2 text-sm font-medium">Set Exam</span>
          </Link>
          ...
          >
            <FiUserPlus />
            <span className="mx-2 text-sm font-medium">Create New User</span>
          </Link>
